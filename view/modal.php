            ...
            <div class="modal_form">
                ...
                <h3>로그인</h3>
                    <form class="sign_in_form" action="../control/Sign_in.php" method="POST">
                            <p class="login_label">
                            <label for="sign_up_id_input">아이디</label>
                ...
                <h3>회원가입</h3>
                    <form class="sign_up_form " action="../control/Sign_up.php" method="POST">
                            <p>
                            <label  for="sign_in_id_input">회원가입 아이디</label>
                            <input type="text" id="sign_in_id_input" name="user_id" pattern="^([a-z0-9_]){3,20}$" autocomplete="off" required> 
                            </p>
                            <p class="login_label"><label for="sign_up_pw_input"> 회원 가입 비밀번호</label>
                             <input type="password" id="sign_up_pw_input" name="user_pw" required></p>
